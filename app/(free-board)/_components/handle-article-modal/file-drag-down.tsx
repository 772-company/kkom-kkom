...
export default function FileDragDown({
  ...
  return (
    <>
      ...
      <section>
        <section className="mx-auto h-full w-full px-5 pt-5">
          <div
            {...getRootProps()}
          ...
          >
            <section className="relative w-full">
              <input {...getInputProps()} />
              {preview === null ? (
                <section className="relative inset-0 flex h-full w-full flex-col items-center justify-center rounded-xl border-2 border-dashed border-background-tertiary bg-white py-4">
                  <MediaIcon />
                ...
                <div className="relative inset-0 mx-auto rounded-xl bg-white">
                  <Image
                    ...
                    className="h-full w-full rounded-xl py-4 hover:cursor-pointer"
                  />
                </div>
              )}
            </section>
