...
const Member = ({ member }: MemberProps) => {
  ...
  return (
    <div className="lg:max-w-[384px] flex h-[73px] max-w-[163.5px] items-center justify-between rounded-[16px] bg-background-secondary px-[24px] py-[20px] md:max-w-[216px]">
