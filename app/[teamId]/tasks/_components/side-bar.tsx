      ...
      >
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-[10px]">
            ...
            <p className="text-xs font-normal text-text-default">오후 3:30분</p>
            <p className="text-xs font-normal text-text-default">|</p>
            <Repeat width={16} height={16} />
            <p className="text-xs font-normal text-text-default">매일 반복 </p>
          </div>

          <div className="min-h-[200px]">
            <p className="text-sm font-normal">
              그 때 당시 너무 많이 들어오는 이력서를 검토하다가 화가 나서 쓴
              글이었다. 글이 좋았는지, 혹은 짤이 좋아서 였는지(박해수 연기짱!),
              정확한 원인은 모르지만 감사하게도 너무 많은 분들이 좋아요를
              눌러주셨다. 요즘에도 좋아요를 눌러주시고 가시는 분들이 계신거 보면
              어느 정도 도움이 되지 않았을까 싶다.
            </p>
          </div>
