...
export default function LandingCard({ variant }: LandingCardProps) {
  ...
  return (
    <section
      className={`${isSecond ? "border border-border-primary border-opacity-10 bg-background-secondary" : "bg-slate-950"} flex h-[467px] flex-col justify-between rounded-[40px] px-[54px] pb-[51px]`}
    >
